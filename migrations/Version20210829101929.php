 ...
 */
final class Version20210829101929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, filename_id INT DEFAULT NULL, adresse_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, prenom VARCHAR(255) NOT NULL, nom VARCHAR(120) NOT NULL, date_de_naissance DATE NOT NULL, telephone VARCHAR(35) NOT NULL, is_completed TINYINT(1) NOT NULL, is_accepted TINYINT(1) NOT NULL, is_available TINYINT(1) NOT NULL, anniversary_date DATE NOT NULL, modif_date DATE NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D64930335DEA (filename_id), UNIQUE INDEX UNIQ_8D93D6494DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
